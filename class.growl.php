<?php
    ...
    class Growl
    {
        ...
        {
            if(function_exists('socket_create') && function_exists('socket_sendto') && (!defined('GROWL_SOCK') || GROWL_SOCK === 'socket'))
            {
            ...
            elseif(function_exists('fsockopen') && (!defined('GROWL_SOCK') || GROWL_SOCK === 'fsock'))
            {
